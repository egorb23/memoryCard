...
questions_list.append(Question('Какого цвета небо', 'голубого', 'синего', 'белого', 'прозрачное'))
questions_list.append(Question('Кто написал Горе от ума?', 'А.С Грибоедов', 'А.С Пушкин', 'Н.И Толстой', 'М.Ю Лермонтов'))
questions_list.append(Question('В каком спорте есть пит-стоп?', 'гонки', 'картинг', 'лыжи', 'велоспорт'))
